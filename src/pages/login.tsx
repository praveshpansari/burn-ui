...
const App: Component = () => {
  return (
    <div class="mx-auto rounded-lg shadow max-w-lg w-full">
      <div class="p-8 text-gray-900">
        <form action="#" class="max-w-md w-full space-y-4">
          ...
          <div class="flex items-center">
            ...
            <div class="text-gray-500 text-center px-5 ">or</div>
            <div class="bg-gray-200 w-full h-0.5"></div>
          </div>

          <div>
            <label for="email" class="font-medium text-sm mb-2 block">
              Email
            </label>
            <input
              type="email"
              name="email"
              id="email"
              class="text-sm p-2.5 bg-gray-50 border-gray-300 border rounded-lg block w-full focus:ring-slate-500 focus:border-slate-500"
          ...
          <div>
            <label for="password" class="font-medium text-sm mb-2 block">
              Password
            </label>
            <input
              type="password"
          ...
          <div class="flex justify-between items-center">
            <div class="flex items-start">
              <div class="flex items-center h-5 ">
                <input
                  ...
                  type="checkbox"
                  class=" bg-gray-50 border-gray-300 border rounded-[0.25rem] w-4 h-4 focus:ring-3 focus:ring-slate-300"
                  required
                />
              </div>
            ...
            <a
              href="#"
              class="text-slate-600 font-medium text-sm hover:underline"
            >
              Forgot password?
            </a>
          </div>
          ...
          <button
            type="submit"
            class="bg-slate-600 text-white font-medium text-sm text-center px-5 py-2.5 rounded-lg w-full hover:bg-slate-700 focus:ring-4 focus:outline-none focus:ring-slate-300"
          >
            Sign in to your account
          </button>
          <p class="text-slate-500 font-light text-sm ">
            Don't have an account?{" "}
            <a href="#" class="text-slate-600 font-medium ">
              Sign up
            </a>
          </p>
        </form>
