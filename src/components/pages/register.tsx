                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" action="#">
                            ...
                            <div class="flex items-center">
                                <div class="bg-gray-200 w-full h-0.5" />
                            ...
                            <div>
                                <label
                                    for="email"
                                    class="block mb-2 text-sm font-medium text-primary-900 dark:text-white"
                                >
                                    Your email
                                </label>
                                <input
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3 text-sm">
                                    <label for="terms" class="font-light text-primary-500 dark:text-primary-300">
                                        By signing up, you are creating a Cashburn account, and you agree to Cashburn's{' '}
                                        <a
